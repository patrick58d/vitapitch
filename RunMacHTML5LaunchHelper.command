...
if [ -f "C:\Program Files (x86)\Epic Games\4.14\Engine\Build\BatchFiles\Mac\SetupMono.sh" ]; then
    pushd "C:\Program Files (x86)\Epic Games\4.14\Engine\Build\BatchFiles\Mac"
	source SetupMono.sh
    popd
fi
